...
This section will describe how to define routes in PyroCMS. It helps to know [how to route in Laravel](https://laravel.com/docs/5.5/routing) already.
...
To learn more about native routing please refer to [Laravel documentation](https://laravel.com/docs/5.5/routing).
